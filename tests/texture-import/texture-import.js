...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'texture-import.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'texture-import.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'texture-import.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_texture_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "texture-import.js.mem" : null;




var STATIC_BUMP = 8400;
